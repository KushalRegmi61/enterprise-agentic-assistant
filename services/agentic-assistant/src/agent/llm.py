...
_GROUNDED_SYSTEM = (
    ...
    "Synthesize the context for a human reader instead of copying tool output, "
    "JSON, field labels, or repeated descriptions. Start with the direct answer "
    "and include only the useful explanation and next step. "
